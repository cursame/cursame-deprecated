Ext.define('Cursame.controller.Main', {
	...
	config: {
		...
		control: {
			...
			'notificationnavigationview':{
				push:'onNotificationPush',
				pop:'onNotificationPop'
			},
			'usernavigationview':{
				push:'onViewPush',
				pop:'onViewPop'
			...
			'notificationnavigationview #signOut':{
				tap:'signOut'
			},		
		}
	},
	...
	onNotificationPush:function(view,pushedview,obj){
		view.down('#signOut').hide();
	},
	onViewPush:function(view,pushedview,obj){
		view.down('#backBtn').hide();
	},
	onNotificationPop: function(view,popedview,obj){
