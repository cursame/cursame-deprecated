...
Ext.define('Cursame.view.courses.CourseNavigationView', {
	...
	requires: ['Cursame.view.courses.CourseList', 'Cursame.view.courses.CourseMenu', 'Cursame.view.users.UserList', 'Cursame.view.assignments.AssignmentList', 'Cursame.view.assignments.AssignmentWall', 'Cursame.view.surveys.SurveyList', 'Cursame.view.surveys.SurveyWall', 'Cursame.view.discussions.DiscussionList', 'Cursame.view.discussions.DiscussionWall'],
	config: {
		items: {
			xtype: 'courselist',
			title: lang.courses
